...
public class NaraeFontSettings extends Screen {
    ...
    private static double scrollbarPosition;
    ...
    class CustomList extends ExtendedList<CustomList.FontEntry> {
        public CustomList(Minecraft mcIn) {
            ...
            for (String name : sortedKeys) {
                ...
                this.addEntry(entry);
                if (entry.font.getPath() == selectedFontPath) {
                    targetEntry = entry;
                }
            }
        ...
        public void setSelected(@Nullable FontEntry entry) {
            String naraeFontName = entry.font.getName();
            String naraeFontFileName = entry.font.getPath();
